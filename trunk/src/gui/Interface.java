...
public class Interface extends JFrame
{
	...
	private JButton boutonExportMatrice;
	...
	public Interface()
	{
		...
		item1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				boutonExportMatrice.setEnabled(true);
		...
		boutonExportMatrice = new JButton("Exporter les données");
		boutonExportMatrice.setEnabled(false);
		boutonExportMatrice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JFileChooser export = new JFileChooser();
				export.showOpenDialog(null);
				try {
					donnees.exporter(export.getSelectedFile().getAbsolutePath());
				} catch (IOException e) {
					e.printStackTrace();
				}
			}
		});
		textuelle.add(boutonExportMatrice);
		textuelle.add(Box.createRigidArea(new Dimension(1, 10)));
